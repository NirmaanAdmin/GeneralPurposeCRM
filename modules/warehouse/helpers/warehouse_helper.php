 ...
 */
function wh_init(){	        
    $token1 = "aG9va3MoKS0+YWRkX2FjdGlvbignd2FyZWhvdXNlX2luaXQnLFdBUkVIT1VTRV9NT0RVTEVfTkFNRS4nX2FwcGludCcp";
    $token2 = "aG9va3MoKS0+YWRkX2FjdGlvbigncHJlX2FjdGl2YXRlX21vZHVsZScsIFdBUkVIT1VTRV9NT0RVTEVfTkFNRS4nX3ByZWFjdGl2YXRlJyk=";
    $token3 = "ZnVuY3Rpb24gd2FyZWhvdXNlX2FwcGludCgp";
    $token4 = "ZnVuY3Rpb24gd2FyZWhvdXNlX3ByZWFjdGl2YXRl";
    $token5 = "aG9va3MoKS0+ZG9fYWN0aW9uKCd3YXJlaG91c2VfaW5pdCcp";
    $path_h = realpath(realpath(__DIR__).'/..'). base64_decode('L2hlbHBlcnMvd2FyZWhvdXNlX2hlbHBlci5waHA=');
    $path_i = realpath(realpath(__DIR__).'/..'). base64_decode('L3dhcmVob3VzZS5waHA=');
    $path_c = realpath(realpath(__DIR__).'/..'). base64_decode('L2NvbnRyb2xsZXJzL1dhcmVob3VzZS5waHA=');
    if(is_file($path_h)){
